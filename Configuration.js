...
var door = endpoints.addEndpoint("1", "Door Status", endpointType.genericSensor);
        door.variableTypeId = 1200;

var trigger = endpoints.addEndpoint("2", "Door trigger number", endpointType.genericSensor);
        trigger.variableTypeId = 1206;

endpoints.addEndpoint("3", "Humidity sensor", endpointType.humiditySensor);

var motion = endpoints.addEndpoint("4", "Motion detection", endpointType.genericSensor);
        motion.variableTypeId = 1201;
